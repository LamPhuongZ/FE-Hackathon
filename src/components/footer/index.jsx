  ...
  return (
    <footer>
      <div className="footer-detail px-10 pt-8 pb-14">
        <div className="footer-line flex justify-between ">
          <div className="footer-line-left flex gap-1 items-center">
            <img
              src="/src/assets/images/logo-company.png"
              alt="Company Logo"
              className="h-10"
            />
            <h1 className="font-bold  pt-2">Việc Làm Dễ</h1>
          </div>
          <div className="footer-line-right flex gap-2">
            <a href="">
              <img
        ...
        <div className="footer-content flex justify-around mt-8">
          <div className="footer-col1">
            <h3 className="font-semibold text-2xl">Về chúng tôi</h3>
            <div className="footer-col1-detail flex flex-col mt-5 space-y-3 font-semibold text-base">
              <a href="">Giới thiệu</a>
              <a href="">Chính sách</a>
          ...
          <div className="footer-col2 ">
            <h3 className="font-semibold text-2xl">Khám phá</h3>
            <div className="footer-col1-detail flex flex-col mt-5 space-y-3 font-semibold text-base">
              <a href="">Tính năng</a>
              <a href="">Liên hệ</a>
              <a href="">Phát triển</a>
          ...
          <div className="footer-col3">
            ...
            <div className="footer-col3-detail flex flex-col mt-5 space-y-3 text-base">
